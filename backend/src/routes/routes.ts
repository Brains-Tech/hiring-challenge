...
const models: TsoaRoute.Models = {
    ...
    "Area": {
        ...
        "properties": {
            ...
            "createdAt": {"dataType":"datetime","required":true},
            "neighborRelations": {"dataType":"array","array":{"dataType":"refObject","ref":"AreaNeighbor"},"required":true},
            "equipment": {"dataType":"array","array":{"dataType":"refObject","ref":"Equipment"}},
            "neighboredByRelations": {"dataType":"array","array":{"dataType":"refObject","ref":"AreaNeighbor"},"required":true},
            "equipmentRelations": {"dataType":"array","array":{"dataType":"refObject","ref":"EquipmentArea"},"required":true},
            "updatedAt": {"dataType":"datetime","required":true},
        },
        "additionalProperties": false,
    },
    ...
    "AreaNeighbor": {
        ...
        "properties": {
            ...
            "neighborId": {"dataType":"string","required":true},
            "notes": {"dataType":"string"},
            "createdAt": {"dataType":"datetime","required":true},
            "createdBy": {"dataType":"string"},
            "area": {"ref":"Area","required":true},
            "neighbor": {"ref":"Area","required":true},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    ...
    "Equipment": {
        ...
        "properties": {
            ...
            "areaRelations": {"dataType":"array","array":{"dataType":"refObject","ref":"EquipmentArea"},"required":true},
            "createdAt": {"dataType":"datetime","required":true},
            "updatedAt": {"dataType":"datetime","required":true},
        },
        "additionalProperties": false,
    ...
    "EquipmentArea": {
        ...
        "properties": {
            ...
            "assignedSince": {"dataType":"datetime"},
            "createdAt": {"dataType":"datetime","required":true},
            "createdBy": {"dataType":"string"},
            "notes": {"dataType":"string"},
    ...
    "Pick_Equipment.Exclude_keyofEquipment.id-or-createdAt-or-updatedAt__": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"name":{"dataType":"string","required":true},"manufacturer":{"dataType":"string","required":true},"serialNumber":{"dataType":"string","required":true},"initialOperationsDate":{"dataType":"datetime","required":true},"area":{"ref":"Area"},"areaId":{"dataType":"string","required":true},"parts":{"dataType":"array","array":{"dataType":"refObject","ref":"Part"}},"areaRelations":{"dataType":"array","array":{"dataType":"refObject","ref":"EquipmentArea"},"required":true}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    ...
    "Partial_Omit_Equipment.id-or-createdAt-or-updatedAt__": {
        "dataType": "refAlias",
        "type": {"dataType":"nestedObjectLiteral","nestedProperties":{"name":{"dataType":"string"},"manufacturer":{"dataType":"string"},"serialNumber":{"dataType":"string"},"initialOperationsDate":{"dataType":"datetime"},"area":{"ref":"Area"},"areaId":{"dataType":"string"},"parts":{"dataType":"array","array":{"dataType":"refObject","ref":"Part"}},"areaRelations":{"dataType":"array","array":{"dataType":"refObject","ref":"EquipmentArea"}}},"validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        const argsTaskController_getTasks: Record<string, TsoaRoute.ParameterSchema> = {
                ...
                dueFrom: {"in":"query","name":"dueFrom","dataType":"string"},
                dueTo: {"in":"query","name":"dueTo","dataType":"string"},
        };
        app.get('/tasks',
        ...
        const argsTaskController_createTask: Record<string, TsoaRoute.ParameterSchema> = {
                requestBody: {"in":"body","name":"requestBody","required":true,"ref":"Omit_Task.id-or-createdAt-or-updatedAt_"},
        };
        app.post('/tasks',
            ...(fetchMiddlewares<RequestHandler>(TaskController)),
        ...
        const argsTaskController_updateTask: Record<string, TsoaRoute.ParameterSchema> = {
                taskId: {"in":"path","name":"taskId","required":true,"dataType":"string"},
                requestBody: {"in":"body","name":"requestBody","required":true,"ref":"Partial_Omit_Task.id-or-createdAt-or-updatedAt__"},
        };
        ...
        app.post('/tasks/:taskId/complete',
            ...(fetchMiddlewares<RequestHandler>(TaskController)),
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsTaskController_startTask: Record<string, TsoaRoute.ParameterSchema> = {
                taskId: {"in":"path","name":"taskId","required":true,"dataType":"string"},
        };
        app.post('/tasks/:taskId/start',
            ...(fetchMiddlewares<RequestHandler>(TaskController)),
            ...(fetchMiddlewares<RequestHandler>(TaskController.prototype.startTask)),

            async function TaskController_startTask(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsTaskController_startTask, request, response });
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsTaskController_cancelTask: Record<string, TsoaRoute.ParameterSchema> = {
                taskId: {"in":"path","name":"taskId","required":true,"dataType":"string"},
        };
        app.post('/tasks/:taskId/cancel',
            ...(fetchMiddlewares<RequestHandler>(TaskController)),
            ...(fetchMiddlewares<RequestHandler>(TaskController.prototype.cancelTask)),

            async function TaskController_cancelTask(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsTaskController_cancelTask, request, response });
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsEquipmentController_assignToAreas: Record<string, TsoaRoute.ParameterSchema> = {
                equipmentId: {"in":"path","name":"equipmentId","required":true,"dataType":"string"},
                requestBody: {"in":"body","name":"requestBody","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"primaryAreaId":{"dataType":"string"},"areaIds":{"dataType":"array","array":{"dataType":"string"},"required":true}}},
        };
        app.post('/equipment/:equipmentId/areas',
            ...(fetchMiddlewares<RequestHandler>(EquipmentController)),
            ...(fetchMiddlewares<RequestHandler>(EquipmentController.prototype.assignToAreas)),

            async function EquipmentController_assignToAreas(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsEquipmentController_assignToAreas, request, response });

                const controller = new EquipmentController();

              await templateService.apiHandler({
                methodName: 'assignToAreas',
                controller,
                response,
                next,
                validatedArgs,
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsEquipmentController_checkAreaRelationship: Record<string, TsoaRoute.ParameterSchema> = {
                equipmentId: {"in":"path","name":"equipmentId","required":true,"dataType":"string"},
                areaId: {"in":"path","name":"areaId","required":true,"dataType":"string"},
        };
        app.get('/equipment/:equipmentId/areas/:areaId',
            ...(fetchMiddlewares<RequestHandler>(EquipmentController)),
            ...(fetchMiddlewares<RequestHandler>(EquipmentController.prototype.checkAreaRelationship)),

            async function EquipmentController_checkAreaRelationship(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsEquipmentController_checkAreaRelationship, request, response });

                const controller = new EquipmentController();

              await templateService.apiHandler({
                methodName: 'checkAreaRelationship',
                controller,
                response,
                next,
                validatedArgs,
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsEquipmentController_getPrimaryArea: Record<string, TsoaRoute.ParameterSchema> = {
                equipmentId: {"in":"path","name":"equipmentId","required":true,"dataType":"string"},
        };
        app.get('/equipment/:equipmentId/primaryArea',
            ...(fetchMiddlewares<RequestHandler>(EquipmentController)),
            ...(fetchMiddlewares<RequestHandler>(EquipmentController.prototype.getPrimaryArea)),

            async function EquipmentController_getPrimaryArea(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsEquipmentController_getPrimaryArea, request, response });

                const controller = new EquipmentController();

              await templateService.apiHandler({
                methodName: 'getPrimaryArea',
                controller,
                response,
                next,
                validatedArgs,
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsAreaController_getAreaNeighbors: Record<string, TsoaRoute.ParameterSchema> = {
                areaId: {"in":"path","name":"areaId","required":true,"dataType":"string"},
        };
        app.get('/areas/:areaId/neighbors',
            ...(fetchMiddlewares<RequestHandler>(AreaController)),
            ...(fetchMiddlewares<RequestHandler>(AreaController.prototype.getAreaNeighbors)),

            async function AreaController_getAreaNeighbors(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsAreaController_getAreaNeighbors, request, response });
        ...
        const argsAreaController_addNeighbor: Record<string, TsoaRoute.ParameterSchema> = {
                areaId: {"in":"path","name":"areaId","required":true,"dataType":"string"},
                requestBody: {"in":"body","name":"requestBody","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"notes":{"dataType":"string"},"connectionType":{"dataType":"string"},"neighborId":{"dataType":"string","required":true}}},
        };
        app.post('/areas/:areaId/neighbors',
            ...(fetchMiddlewares<RequestHandler>(AreaController)),
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        const argsAreaController_checkNeighborRelation: Record<string, TsoaRoute.ParameterSchema> = {
                areaId: {"in":"path","name":"areaId","required":true,"dataType":"string"},
                neighborId: {"in":"path","name":"neighborId","required":true,"dataType":"string"},
        };
        app.get('/areas/:areaId/neighbors/:neighborId',
            ...(fetchMiddlewares<RequestHandler>(AreaController)),
            ...(fetchMiddlewares<RequestHandler>(AreaController.prototype.checkNeighborRelation)),

            async function AreaController_checkNeighborRelation(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsAreaController_checkNeighborRelation, request, response });

                const controller = new AreaController();

              await templateService.apiHandler({
                methodName: 'checkNeighborRelation',
                controller,
                response,
                next,
                validatedArgs,
